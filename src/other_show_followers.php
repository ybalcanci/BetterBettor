    ...
    <div id="navigation" >
      ...
      <div class="panel container-fluid col-md-7" >
        <?php
  				...
  				echo "
  				<h3 class=\"page-header\" style=\"font-weight: bold;\"> Followers </h3>
            ...
            $sql = "SELECT follower_tid FROM Follow WHERE followed_tid = " . $other_user_tid . ";";
            $followers = mysqli_query($conn, $sql);

            while($follower = mysqli_fetch_assoc($followers)) {
              $sql = "SELECT * from User where tid =  \"" . $follower['follower_tid'] . "\";";
            ...
            /*
            <a href=\"/~n.musevitoglu/userProfile.php\">
