    ...
    <div id="navigation" >
      ...
      <div class="panel container-fluid col-md-7" >
        <?php
  				...
  				echo "
  				<h3 class=\"page-header\" style=\"font-weight: bold;\"> Results Found </h3>
				...
				if (isset($_POST['search'])){
					...
					$sql = "SELECT tid FROM User WHERE name like \"%" . $searchq . "%\" UNION select tid from User where surname like \"%" . $searchq . "%\" UNION select tid from User where concat(name, \"". " \", surname) like  \"%" . $searchq . "%\";";
            		$followers = mysqli_query($conn, $sql);

					//echo "<script type='text/javascript'>alert('$searchq');</script>";
					...
					if ($count == 0) {
						...
						//echo "<script type='text/javascript'>alert('I am in ');</script>";
