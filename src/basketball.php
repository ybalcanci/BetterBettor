...
<?php 
$sql = "SELECT min(match_id),max(match_id) from B_Match;";
...
function addMatch(){
  ...
  let i = 0;
  var maxMatchId="<?php echo $htmlString; ?>";
...
<div class="container" style="margin-top:80px;">
    ...
    <div class="panel container-fluid col-md-8" >
			<?php
			$sql = "SELECT * FROM showBasketball;";
		      ...
		      <tr>
		    	...
		    	while($match = mysqli_fetch_assoc($matches)) {
						...
						<tr>
							...
							<td>" . $match["time"] . "</td>
							<td>" . $match["min_bet"] . "</td>
							<td><a href='match_details.php?match_id=".$match["match_id"]."'>".$team1["team_name"] . " - " . $team2["team_name"] . "</td>
    ...
    <div class="panel container-fluid col-md-4" style="border:solid; position:fixed; left:65%;">
    	...
    	<form class="form-inline">
				...
				<select id="odd_to_add">
					...
					<option value="A150.5">A150.5</option>
					<option value="B150.5">B150.5</option>
				</select>
